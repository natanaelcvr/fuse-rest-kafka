...
public class DynamicAttribute__1 {
    ...
    public String toString() {
        ...
        sb.append(DynamicAttribute__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DynamicAttribute__1) == false) {
            return false;
        }
        DynamicAttribute__1 rhs = ((DynamicAttribute__1) other);
